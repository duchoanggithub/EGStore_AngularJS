...
} from "./chunk-VR5YBKVB.js";
import "./chunk-O6JAJHOO.js";
import {
  TemplatePortal
} from "./chunk-57RCCGD3.js";
import {
  UniqueSelectionDispatcher
} from "./chunk-QISTOCM5.js";
import {
  FocusKeyManager,
  InputModalityDetector
} from "./chunk-VMTNNPJF.js";
import {
  DOWN_ARROW,
  Directionality,
  ENTER,
  ...
  _getEventTarget,
  hasModifierKey
} from "./chunk-UY65LDPL.js";
import "./chunk-2ZJSW6PF.js";
import {
  ChangeDetectorRef,
  ContentChildren,
  Directive,
...
_CdkMenuGroup.ɵfac = function CdkMenuGroup_Factory(t) {
...
_MenuStack.ɵfac = function MenuStack_Factory(t) {
...
_CdkMenuTriggerBase.ɵfac = function CdkMenuTriggerBase_Factory(t) {
...
_TargetMenuAim.ɵfac = function TargetMenuAim_Factory(t) {
...
_CdkTargetMenuAim.ɵfac = function CdkTargetMenuAim_Factory(t) {
...
_CdkMenuTrigger.ɵfac = function CdkMenuTrigger_Factory(t) {
...
_CdkMenuTrigger.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    menuTemplateRef: [InputFlags.None, "cdkMenuTriggerFor", "menuTemplateRef"],
    menuPosition: [InputFlags.None, "cdkMenuPosition", "menuPosition"],
    menuData: [InputFlags.None, "cdkMenuTriggerData", "menuData"]
  },
  outputs: {
...
_CdkMenuItem.ɵfac = function CdkMenuItem_Factory(t) {
...
_CdkMenuItem.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    disabled: [InputFlags.HasDecoratorInputTransform, "cdkMenuItemDisabled", "disabled", booleanAttribute],
    typeaheadLabel: [InputFlags.None, "cdkMenuitemTypeaheadLabel", "typeaheadLabel"]
  },
  outputs: {
...
_CdkMenuBase.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function CdkMenuBase_Factory(t) {
    return (ɵCdkMenuBase_BaseFactory || (ɵCdkMenuBase_BaseFactory = ɵɵgetInheritedFactory(_CdkMenuBase)))(t || _CdkMenuBase);
  };
})();
...
_CdkMenu.ɵfac = function CdkMenu_Factory(t) {
...
_CdkMenuBar.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function CdkMenuBar_Factory(t) {
    return (ɵCdkMenuBar_BaseFactory || (ɵCdkMenuBar_BaseFactory = ɵɵgetInheritedFactory(_CdkMenuBar)))(t || _CdkMenuBar);
  };
})();
...
_CdkMenuItemSelectable.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function CdkMenuItemSelectable_Factory(t) {
    return (ɵCdkMenuItemSelectable_BaseFactory || (ɵCdkMenuItemSelectable_BaseFactory = ɵɵgetInheritedFactory(_CdkMenuItemSelectable)))(t || _CdkMenuItemSelectable);
  };
})();
_CdkMenuItemSelectable.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    checked: [InputFlags.HasDecoratorInputTransform, "cdkMenuItemChecked", "checked", booleanAttribute]
  },
  standalone: true,
...
_CdkMenuItemRadio.ɵfac = function CdkMenuItemRadio_Factory(t) {
...
_CdkMenuItemCheckbox.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function CdkMenuItemCheckbox_Factory(t) {
    return (ɵCdkMenuItemCheckbox_BaseFactory || (ɵCdkMenuItemCheckbox_BaseFactory = ɵɵgetInheritedFactory(_CdkMenuItemCheckbox)))(t || _CdkMenuItemCheckbox);
  };
})();
...
_ContextMenuTracker.ɵfac = function ContextMenuTracker_Factory(t) {
...
_CdkContextMenuTrigger.ɵfac = function CdkContextMenuTrigger_Factory(t) {
...
_CdkContextMenuTrigger.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    menuTemplateRef: [InputFlags.None, "cdkContextMenuTriggerFor", "menuTemplateRef"],
    menuPosition: [InputFlags.None, "cdkContextMenuPosition", "menuPosition"],
    menuData: [InputFlags.None, "cdkContextMenuTriggerData", "menuData"],
    disabled: [InputFlags.HasDecoratorInputTransform, "cdkContextMenuDisabled", "disabled", booleanAttribute]
  },
  outputs: {
...
_CdkMenuModule.ɵfac = function CdkMenuModule_Factory(t) {
